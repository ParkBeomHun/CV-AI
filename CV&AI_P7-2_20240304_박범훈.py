...
from keras.optimizers import SGD        #SGD를 학습 알고리즘으로 사용
...
mlp.compile(loss='MSE', optimizer = SGD(learning_rate=0.01),metrics=['accuracy'])               #loss 함수로 평균오차제곱 / 학습률 0.01 / SGD 학습 알고리즘 사용 / 정확률을 기준으로 성능 측정
